      ...
      <form>
        <div className="form-group row">
          ...
          <div className="col-sm-10">
            <input type="text" className="form-control" id="inputName" placeholder="eg. John Doe" />
          </div>
        </div>
        ...
        <div className="form-group row">
          ...
          <div className="col-sm-10">
            <input type="number" className="form-control" id="inputNumber" placeholder="eg. 9810098200" />
          </div>
        </div>
        ...
        <div className="form-group row">
          ...
          <div className="col-sm-10">
            <input type="email" className="form-control" id="inputEmail3" placeholder="eg. johndoe@email.com" />
          </div>
        </div>
        ...
        <div className="form-group row">
          ...
          <div className="col-sm-10">
            <input type="text" className="form-control" id="inputAddress" placeholder="eg. Kathmandu" />
          </div>
        </div>
        ...
        <div className="form-group row">
          ...
          <div className="col-sm-10">
            <select className="custom-select form-control" id="nationality" name="nationality">
        ...
        <div className="form-group row">
          ...
          <div className="col-sm-10">
            <input type="text" className="form-control" id="inputInstitution" placeholder="eg. Himalaya College of Engineering" />
          </div>
        </div>
